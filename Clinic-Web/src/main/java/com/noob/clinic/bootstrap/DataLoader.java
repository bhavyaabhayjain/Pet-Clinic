package com.noob.clinic.bootstrap;
...
import com.noob.clinic.model.Visit;
...
import com.noob.clinic.services.VisitService;
import com.noob.clinic.services.map.OwnerMapService;
import com.noob.clinic.services.map.VetMapService;

@Component//it registers as spring bean and gets registered in spring context
public class DataLoader implements CommandLineRunner{
	...
	private void loadData() {
		...
		owner3.setFirstName("Bhavya");
		owner3.setLastName("Jain");	
		owner3.setAddress("Shahibaug");		
